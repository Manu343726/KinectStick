...
namespace WindowsInput.Native
{
    ...
    internal static class NativeMethods
    {
        ...
        /// </summary>
        /// <param name="keyCode">The virtual key code or scan code for a key. How this value is interpreted depends on the value of the uMapType parameter</param>
        /// <param name="mapType">The translation to be performed. The value of this parameter depends on the value of the uCode parameter. See http://msdn.microsoft.com/en-us/library/windows/desktop/ms646306(v=vs.85).aspx (Table)</param>
        ...
        [DllImport("user32.dll")]
        public static extern UInt32 MapVirtualKey(UInt32 keyCode, UInt32 mapType);
    }
}