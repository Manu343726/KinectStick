                                    ...
                                    new KEYBDINPUT
                                        {
                                            ...
                                            Scan = 0,
                                            Flags = IsExtendedKey(keyCode) ? (UInt32) (KeyboardFlag.ExtendedKey) : (UInt32) 0,
                                            Time = 0,
                        ...
                        Data =
                            {
                                Keyboard =
                                    new KEYBDINPUT
                                        {
                                            KeyCode = 0,
                                            Scan = (UInt16) NativeMethods.MapVirtualKey((UInt32) keyCode, (UInt32) KeyCodeTranslation.MAPVK_VSC_TO_VK),
                                            Flags = (UInt32) (IsExtendedKey(keyCode)
                                                                  ? KeyboardFlag.KeyUp | KeyboardFlag.ExtendedKey | KeyboardFlag.ScanCode
                                         ...
                                         new KEYBDINPUT
                                             {
                                                 ...
                                                 Scan = scanCode,
                                                 Flags =
                                                     (UInt32)(KeyboardFlag.KeyUp | KeyboardFlag.Unicode | KeyboardFlag.ScanCode),
                                                 Time = 0,
                                                 ExtraInfo = IntPtr.Zero
                                             }
                                 }
